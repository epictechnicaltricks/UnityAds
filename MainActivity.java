...
public class MainActivity extends  AppCompatActivity  {
	...
	// IF YOU FACE ANY PROBLEM COMMENT ON MY VIDEOS

	// HTTPS://YOUTUBE.COM/EPICTECHNICALTRICKS
	...
	IUnityAdsShowListener showListener = new IUnityAdsShowListener() {
		...
		public void onUnityAdsShowStart(String s) {
			...
			Toast.makeText(MainActivity.this,
					"Ad showing ", Toast.LENGTH_SHORT).show();
		}
		...
		public void onUnityAdsShowComplete(String s, UnityAds.UnityAdsShowCompletionState unityAdsShowCompletionState) {
			...
			Toast.makeText(MainActivity.this,
					"Ad Complete", Toast.LENGTH_SHORT).show();
		}
	};
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				Toast.makeText(MainActivity.this,
						"Show btn clicked ", Toast.LENGTH_SHORT).show();
			}
		});
